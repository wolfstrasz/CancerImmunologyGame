...
namespace ImmunotherapyGame.Loader
{
	...
	public class Intro : MonoBehaviour
	{
		...
		[SerializeField] private bool forceSkip = false;

		[Header("Logos")]
		[SerializeField] private Animator logoAnimator = null;
		[SerializeField] private float timeBeforeLogoFade = 3.0f;

		[Header("Intro texts")]
		[SerializeField] private List<GameObject> texts = new List<GameObject>();
		[SerializeField] [ReadOnly] private int text_index = 0;

		[Header("Skip text functionality")]
		[SerializeField] private TMP_Text continueTxt = null;
		[SerializeField] private Slider skipHoldSlider = null;
		[SerializeField] private float timeBeforeSkipAppears = 2.0f;
		[SerializeField] private float timeHoldToSkip = 2.0f;
		[SerializeField] [ReadOnly] private bool allowSkip = false;
