...
namespace ImmunotherapyGame.Abilities
{
    public class AbilityEffectManager : Singleton<AbilityEffectManager>
    {
        ...
        /// <summary>
        /// Resets the pool of ability effects when the scene changes.
        /// </summary>
        ...
        /// <summary>
        /// Return a free ability effect matching the ability from the pool.
        /// If there are not free ability effects it instantiates a new one.
        /// </summary>
        ...
        /// <summary>
        /// Recycles the ability effect entity by adding it in the pool of free effects.
        /// </summary>
        ...
        internal void OnEffectLifeEnd(AbilityEffect effect)
		{
            if (effect == null)
			{
                Debug.LogError("Null effect requested to be recycled");
                return;
			} 
